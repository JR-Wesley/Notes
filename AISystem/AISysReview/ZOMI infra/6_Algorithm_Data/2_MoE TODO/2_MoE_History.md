...
![](assets/2_MoE_History.assets/02MOEHistory_03.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_04.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_05.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_06.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_07.png)
...
- N：专家总数
- μ：容量因子 (通常 1.0-1.25)
![](assets/2_MoE_History.assets/02MOEHistory_08.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_09.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_10.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_11.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_12.png)

如上图所示，其有 8 个独立的专家网络。每个专家中包含 32 个 Transformer block。

![](assets/2_MoE_History.assets/02MOEHistory_13.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_14.png)

从上图可以看出，尽管存在负载均衡机制，**自然任务分布**导致不可避免的不均衡。但最忙碌 Expert 仍可获得比最闲 Expert 多 40%~60% Tokens。

![](assets/2_MoE_History.assets/02MOEHistory_15-1.png)
...
![](assets/2_MoE_History.assets/02MOEHistory_16.png)
